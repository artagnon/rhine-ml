...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9bc1ae4c7ce92e47a07c69356488b750) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["bindings.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-rdynamic"])];
                   ...
                   {exec_custom = false; exec_main_is = "rhine.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\1624)\194\023\168\215\163\155U\235;\157(\172(";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
